...
#  Displaying Student Information
    ...
    display(f'English: {gr1} ', target='output1')
    display(f'Science: {gr2} ', target='output1')
    display(f'ICT: {gr3}', target='output1')
    display(f'Math: {gr4} ', target='output1')
    display(f'Filipino: {gr5} ', target='output1')
